...
const LayoutDashboardIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  ({ size = 24, className = "", strokeWidth = 2, color = "currentColor" }, ref) => {
    ...
    return (
      <motion.svg ref={scope} onHoverStart={start} onHoverEnd={stop} xmlns="http://www.w3.org/2000/svg"
        width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" color={color}
        strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" className={className} initial={{ x: 0, y: 0 }}>
