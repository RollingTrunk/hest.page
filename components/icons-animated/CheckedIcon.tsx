...
const CheckedIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  ({ size = 24, color = "currentColor", strokeWidth = 2, className = "" }, ref) => {
    ...
    return (
      <motion.div ref={scope} onHoverStart={start} onHoverEnd={stop} style={{ display: "inline-flex" }}>
        <motion.svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none"
